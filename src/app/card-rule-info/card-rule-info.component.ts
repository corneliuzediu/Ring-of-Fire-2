...
@Component({
    ...
    styleUrl: './card-rule-info.component.scss',
})
export class CardRuleInfoComponent {
    cardAction = [
        {
            title: 'Waterfall',
            description:
        ...
        },
        {
            title: 'Thumbmaster',
            description:
                'Tha last person who put the finger on the desk/table must drink.',
        },
        { title: 'Men', description: 'All men must drink.' },
        {
            title: 'Quizmaster',
            description:
                'If a player does not answer the "Quizmaster" question with another question, the player must drink. The quizmaster status is attached to the player until the next "Quizmaster card" is being picked.',
        },
        {
